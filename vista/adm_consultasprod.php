	    										...
	    										<form id="form-fecha_producto">		      			
									      			<div class="row">
										      			...
										      			<div class="form-group">
										      			 ...
										      			 <button type="button" class="imprimir_reporte_producto btn bg-gradient-primary float-right m-2 pt-lg-0">Imprimir</button>  			
										      		</div>	      			      			
									      		</form>						    										
	    									</div>
	    									<div class="card-body p-0 table-responsive">
	    										<table id="tabla_venta_productos" class="table table-borderless" style="width:100%">
											        <thead>
											            <tr>
