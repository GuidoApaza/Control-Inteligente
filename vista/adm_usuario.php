	    ...
	    <div class="modal-content">
	      	<div class="card card-dark">
		      	...
		      	<div class="card-footer">
		      		<button type="submit" class="btn bg-gradient-dark float-right m-1">Guardar</button>
		      		</form>
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-12">
	            <h1>
					<button id="button-crear" type="button" data-toggle="modal" data-target="#crearusuario" class="btn bg-gradient-dark ml-2">Crear Usuario</button>					
	            </h1>	            
	    ...
	    <section>
	    	<div class="container-fluid">
	    		<div class="card-dark">
					...
					<div id="usuarios" class="row d-flex aling-items-strech">
	    				</div>
	    		</div>
	    	</div>
	    </section>    	   
