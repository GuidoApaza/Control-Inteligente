				...
				template+=`$ 
					<tr labId="${laboratorio.id}" labNombre="${laboratorio.nombre}" labAvatar="${laboratorio.avatar}">
						...
						<td>
							...
							<button class="editar btn btn-primary" title="Editar el Laboratorio" type="button" data-toggle="modal" data-target="#crearlaboratorio">
								<i>Editar</i>
								<!-- class="fas fa-pencil-alt"-->
							</button>
							<button class="borrar btn btn-primary" title="Borrar Laboratorio">
								<i>Eliminar</i>
								<!--class="fas fa-trash"-->
							</button>
						</td>
