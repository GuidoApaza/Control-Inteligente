			...
			presentaciones.forEach(presentacion => {
				template+=`$ 
					<tr preId="${presentacion.id}" preNombre="${presentacion.nombre}">
						...
						<td>							
							<button class="editar-pre btn btn-primary" title="Editar Presentacion" type="button" data-toggle="modal" data-target="#crearpresentacion">
							<i>Modificar</i>	
							</button>
							<button class="borrar-pre btn btn-primary" title="Borrar presentacion">
						<i>Eliminar</i>	
							</button>
						</td>
					</tr>
