		...
		$.post('../controlador/ProveedorController.php',{consulta,funcion},(response)=> {
			...
			proveedores.forEach(proveedor =>{
				...
				<tr provId="${proveedor.id}" provNombre="${proveedor.nombre}" provTelefono="${proveedor.telefono}" provCorreo="${proveedor.correo}" provDireccion="${proveedor.direccion}" provAvatar="${proveedor.avatar}">
						...
						<button class="avatar btn btn-sm btn-primary" title="Editar logo" type="button" data-toggle="modal" data-target="#cambiologo">
						editar imagen
					  </button>
					   <button class="editar btn btn-sm btn-primary" title="Editar proveedor" type="button" data-toggle="modal" data-target="#crearproveedor">
						editar 
					  </button>
					   <button class="borrar btn btn-sm btn-primary" title="Borrar proveedor">
						eliminar
					  </button>
						</td>
					</tr>
